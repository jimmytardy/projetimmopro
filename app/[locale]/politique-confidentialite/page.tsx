...
export const metadata: Metadata = {
  ...
  description: 'Politique de confidentialité de PrêtImmoPro : données collectées, Matomo Analytics sans cookies, AdSense, droits RGPD.',
...
const SECTIONS = [
  ...
  { id: 'vercel',       title: '5. Hébergeur (Vercel)' },
...
export default function PolitiqueConfidentialitePage() {
  return (
    ...
    >
      ...
      <p>
        <a
          href={`${process.env.NEXT_PUBLIC_MATOMO_URL ?? 'https://analytics.votredomaine.fr'}/index.php?module=CoreAdminHome&action=optOut&language=fr`}
          target="_blank"
      ...
      <p>
        ...
        Vercel) directement sur leurs plateformes respectives.
      </p>
      <p>
      ...
      <ul>
        ...
        <li><strong>Logs Vercel :</strong> 30 jours ;</li>
